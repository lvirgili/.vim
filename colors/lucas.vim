...
hi Normal guifg=#f5f7f7 guibg=#142837
hi Comment guifg=#80a0ff guibg=NONE
hi Constant guifg=#ff80ff guibg=NONE
hi String guifg=#2ec6a5 guibg=NONE
hi htmlTagName guifg=#962d3e guibg=NONE
hi Identifier guifg=#40ffff guibg=NONE
hi Statement guifg=#aa4444 guibg=NONE
hi PreProc guifg=#ff80ff guibg=NONE
hi Type guifg=#21a884 guibg=NONE
hi Function guifg=#92cdcf guibg=NONE
hi Repeat guifg=#f5f7f7 guibg=NONE
